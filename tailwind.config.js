const {nextui} = require("@nextui-org/theme"); // Добавлено
const flowbite = require("flowbite-react/tailwind"); // Добавлено

/** @type {import('tailwindcss').Config} */
module.exports = {
  /*   important: true, */
    content: [
      flowbite.content(), // Добавлено
      "./src/**/*.{js,jsx,ts,tsx}",
      "./node_modules/@nextui-org/theme/dist/components/pagination.js" // Добавлено
    ],
    theme: {
      extend: {
        backgroundImage: {
          'custom-background': "url('src/../img/back_1_mb.jpg')", // Вот так можно поставить свой бекграунд
        },
        keyframes: {
          cursor: {
